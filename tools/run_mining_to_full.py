...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        "start_iron": result.start_iron,
        "end_iron": result.end_iron,
        "start_gems": result.start_gems,
        "end_gems": result.end_gems,
        "start_gem_item_ids": list(result.start_gem_item_ids),
        "end_gem_item_ids": list(result.end_gem_item_ids),
        "inventory_confidence": final_confidence,
        "verified_ores": result.verified_ores,
        "verified_gems": result.verified_gems,
